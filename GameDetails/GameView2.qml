...
id: root
    ...
    property real detailsOpacity: 1 //(settings.DetailsDefault === "Yes") ? 1 : 0
	...
	//property var collectionPublisher: getCollection(''
...
*/
    ...
    id: extrasModel
        ...
        id: list2
            ...
            title: game ? "More " + (game.genreList[0] ? game.genreList[0].toLowerCase() : "") + " games" : ""
    ...
    id: content
        ...
        anchors {
            left: parent.left; leftMargin: globalMargin// vpx(70)
            right: parent.right
